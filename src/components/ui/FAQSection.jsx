...
const FAQSection = () => {
  ...
  const faqs = {
    ...
    delivery: [
      ...
      },
      {
        ...
        answer: "If you are travelling or indulging in festivities, you can skip your next bag or reschedule your bag, or pause your deliveries through our app. If you are away for a longer period you can write to us on EatFresh@NaturallyGood.in mentioning your Customer and Order ID with the subject 'Delivery Hold'.\n\nIf you do not prepare, reschedule or skip your bag before 8 PM prior to the delivery day, a standard bag based on your previous preferences will be automatically scheduled and delivered."
      }
    ],
    order: [
      {
  ...
  return (
    <section id="faq" data-section="faqs" className="py-20 bg-gradient-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden">
