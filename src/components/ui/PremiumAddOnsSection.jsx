...
import { Package, Heart, ShoppingBag, Star, ArrowRight, CheckCircle, X, Smartphone, Award, Zap, Leaf } from 'lucide-react';
...
const PremiumAddOnsSection = () => {
  ...
  const handleKnowMore = (product) => {
    const message = `Hi! I'd like to know more about the ${product.name} program. Can you provide detailed information about the services and pricing?`;
    window.open(`https://wa.me/919643722200?text=${encodeURIComponent(message)}`, '_blank');
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
            Enhance your wellness journey with our premium products, nutrition packs, and specialized programs designed for your healthy lifestyle.
          </p>
        </div>
...
export default PremiumAddOnsSection;
