...
export function MacbookScrollDemo() {
  return (
    <div className="w-full overflow-hidden bg-white dark:bg-[#0B0B0F] pt-20">
      <MacbookScroll
        title={
          <div className="text-center">
            ...
            <br />
            <span className="text-lg font-normal text-neutral-600 dark:text-neutral-400 mt-4 block">
              Discover our premium Seasonal Veggie Basket with farm-fresh organic vegetables
            </span>
        ...
        src={`https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80`}
        showGradient={false} />
    </div>
  );
}
